...
const LandingPage = () => {
  return (
    <main className="flex flex-col gap-10 sm:gap-20 py-10 sm:py-20 items-center text-center">
  <section>
    <h1 className="gradient-title font-extrabold text-4xl sm:text-6xl lg:text-8xl tracking-tighter py-4">
      Get Your Dream Job
      <span className="flex justify-center gap-2 sm:gap-6">
       Get your candidates
      </span>
    </h1>
